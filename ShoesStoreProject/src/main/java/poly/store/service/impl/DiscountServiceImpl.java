...
public class DiscountServiceImpl implements DiscountService {
	...
	public User sendCodeDiscount(Integer discountId, User user) {
		...
		mailerService.queue(user.getEmail(), "SHOETOPIA. Thông Tin Khuyến Mãi!",
				"Xin chào bạn " + user.getFullname() +",<br>"
				+ "Shoetopia xin thông báo đến bạn chương trình. " + discount.getName() + " khi bạn nhập mã <b>" + discount.getCode() + "</b>." + "<br>"
