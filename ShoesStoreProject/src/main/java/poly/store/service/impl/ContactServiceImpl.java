...
//		send mail thanks guests
		mailerService.queue(contactModel.getEmail(), "Thông Báo shoetopia.com",
				"Kính chào " + name +",<br>"
				+ "Đại diện shoetopia xin chân thành cảm ơn bạn đã ghé qua và để lại đánh giá ý kiến cá nhân về shop. "
