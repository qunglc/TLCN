...
function disableAddress(){
    $("#txtAddress").text("Phương thức vận chuyển");
...
function disableMethod(){
    $("#txtMethod").text("Phương thức vận chuyển");
...
function disableConfirm(){
    $("#txtConfirm").text("Xác nhận đơn hàng");
...
function checkForm(){
    ...
    if(province == ""){
        $("#errorProvince").text("Vui lòng nhập tỉnh/thành!");
    ...
    if(district == ""){
        $("#errorDistrict").text("Vui lòng nhập quận/huyện!");
    ...
    var ward = $("#ward").val();
    if(ward == ""){
        $("#errorWard").text("Vui lòng nhập phường/xã!");
